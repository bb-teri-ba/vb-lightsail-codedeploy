    ...
    <body onload='init(); '>
        ...
        <aside class="call-to-action bg-primary text-white">
            <div class="container text-center">
                <h3>Update your account and destination</h3>
            </div>
        </aside>
        <br>
        ...
        <div class= "map">
            <div id="controlPanel">
                ...
                <div class="row">
                    ...
                    <input type="email" name ="email" value="<?php echo $email_address;?>"required>
                </div>
                <div class="row">
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <input type ="Tel" name ="phone" value="<?php echo $telephone;?>" required>
                </div>
            </fieldset>
            <fieldset>
                ...
                <div class ="row">
                    ...
                    <select name = "start" id="start" value="<?php echo $start;?>">
                ...
                <div class ="row">
                    ...
                    <select name="end" id="end" value="<?php echo $end;?>">
                        <option value = "cliffsMoher">Cliffs of Moher, Co. Clare</option>
                        <option value = "glendalough">Glendalough, Co. Wicklow</option>
                        <option value = "muckross">Muckross House & Gardens, Co. Kerry</option>
                        <option value = "powerscourt">Powerscourt House and Gardens, Co. Wicklow</option>
